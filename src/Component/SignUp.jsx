...
const FEATURES = [
  ...
  { icon: "&#10084;", text: "Save products to wishlist" },
    ...
    <div style={{
      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ marginBottom: "18px" }}>
            ...
            <input
              ...
              style={{ ...inputStyle, borderColor: focused === "name" ? "#f7971e" : "#e0e0e0" }}
            />
          </div>
        ...
        <p style={{ textAlign: "center", margin: 0, fontSize: "0.88rem", color: "#888" }}>
          ...
          <Link to="/Login" style={{ color: "#e52d27", fontWeight: 700, textDecoration: "none" }}>
            Log in
          </Link>
        </p>
      </div>
